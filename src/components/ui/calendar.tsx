  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: 'h-9 w-9 text-center text-sm p-0 rounded-md relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-gray-100/50 [&:has([aria-selected])]:bg-purple-400 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-gray-800/50 dark:[&:has([aria-selected])]:bg-gray-800',
        day: cn(
        ...
        day_selected:
          'bg-purple-400 text-white hover:bg-purple-500 focus:bg-gray-900 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900',
        day_today:
          'bg-purple-400 text-gray-900 dark:bg-gray-800 dark:text-gray-50',
        day_outside:
