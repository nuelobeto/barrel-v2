...
>(({className, ...props}, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-semibold text-xs text-neutral-600 bg-periwinkle-25 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
...
>(({className, ...props}, ref) => (
  <td
    ref={ref}
    className={cn(
      'h-12 px-4 align-middle font-medium text-xs text-neutral-400 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
