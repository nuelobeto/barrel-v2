...
export default function UploadTemplateTriggerAction({
  children,
}: {
    ...
    <Sheet>
      ...
      <SheetContent className="h-auto m-6">
        ...
        <div className="grow flex flex-col">
          <Label>Would this document require a signature</Label>
          ...
          <div
            {...getRootProps()}
            className="mt-5 bg-periwinkle-25 border-2 border-periwinkle-400 border-dashed rounded-xl py-5 flex items-center justify-center"
          >
            <input {...getInputProps()} />
            <div className="flex flex-col items-center justify-center w-full max-w-[266px]">
              ...
              <Text variant="body6" className="mt-1.5 text-neutral-300">
                or drag and drop your PDF File (5 MB Max)
              </Text>
              <Button
